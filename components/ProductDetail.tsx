...
const ProductDetail = ({ product }: ProductDetailProps) => {
  ...
  const whatsappUrl = `https://wa.me/923102722269?text=${encodeURIComponent(
  `I'm interested in ${product.title} - Rs. ${product.salePrice || product.price}. 
  Check it out: ${typeof window !== 'undefined' ? window.location.origin : ''}/products/${product.slug.current}`
)}`;
